...
/* ════ MARQUEE ════ */
function Marquee({ items, coral = false, reverse = false }) {
    const tripled = [...items, ...items, ...items];
    return (
        <div style={{ background: coral ? C.coral : C.creamDark, padding: "0.9rem 0", overflow: "hidden" }}>
            <div style={{
                ...
                {tripled.map((item, i) => (
                    <span key={i} style={{
                        ...
                        {item}
                        <span style={{ color: coral ? "rgba(255,255,255,0.5)" : C.coral, fontSize: "0.48rem" }}>●</span>
                    </span>
                ))}
            </div>
            <style>{`
    ...
    return (
        <div
            ...
            style={{
                ...
                boxShadow: hov ? "0 8px 30px rgba(61,26,120,0.09)" : "none",
                transition: "all 0.3s",
            }}
        >
            <div style={{
                width: 48, height: 48, borderRadius: 12, flexShrink: 0,
                background: "rgba(61,26,120,0.07)",
...
function HowWeWorkPanel({ sm, md, desktop }) {
    const STEPS = [
        {
            num: "01", label: "Discovery", icon: "🔍", color: "#FF8C00",
        ...
        {
            num: "02", label: "Design", icon: "🎨", color: "#FFBA08",
        ...
        {
            num: "03", label: "Build", icon: "⚙️", color: "#FF7B00",
        ...
        {
            num: "04", label: "Launch", icon: "🚀", color: "#FFA000",
        ...
        {
            num: "05", label: "Support", icon: "🛡️", color: "#FF6B00",
    ...
    return (
        <section style={{
            background: "linear-gradient(160deg, #1A0A00 0%, #2D1200 40%, #3D1900 70%, #1A0800 100%)",
            ...
            <div style={{
                ...
                backgroundImage: "radial-gradient(rgba(255,200,100,0.15) 1px, transparent 1px)",
            ...
            {/* Top bar */}
            <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: 3, background: `linear-gradient(90deg, transparent, ${ac}, #FFBA08, transparent)`, opacity: 0.9, transition: "background 0.7s" }} />
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "0.55rem" }}>
                            {STEPS.map((s, i) => (
                                <button
                                    ...
                                    style={{
                                        ...
                                        border: `1.5px solid ${active === i ? s.color : "rgba(255,220,100,0.12)"}`,
                                ...
                                >
                                    <div style={{
                                        ...
                                        <span style={{
                                            ...
                                            color: active === i ? "#fff" : "rgba(255,200,100,0.45)",
                                    ...
                                    <div style={{ flex: 1 }}>
                                        <div style={{
                                            ...
                                            color: active === i ? s.color : "rgba(255,230,160,0.7)",
                                            transition: "color 0.28s",
                                        }}>{s.label}</div>
                                        <div style={{
                            ...
                            <button
                                ...
                                style={{
                                    ...
                                    color: "rgba(255,200,100,0.38)", textAlign: "left",
                        ...
                        <div style={{ display: "flex", justifyContent: "center", gap: "0.5rem" }}>
                            {STEPS.map((s, i) => (
                                <button key={i} onClick={() => handleSelect(i)} style={{
                                    ...
                                    background: active === i ? s.color : "rgba(255,200,100,0.2)",
                            ...
                            {STEPS.map((s, i) => (
                                <button key={s.num} onClick={() => handleSelect(i)} style={{
                                    ...
                                    <div style={{
                                        ...
                                        <span style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: "0.62rem", color: active === i ? "#fff" : "rgba(255,200,100,0.4)" }}>{s.num}</span>
                                    </div>
                                    <div style={{ fontFamily: "'Syne',sans-serif", fontWeight: 700, fontSize: "0.72rem", color: active === i ? s.color : "rgba(255,230,160,0.65)" }}>{s.label}</div>
                                </button>
                            ))}
                        </div>
...
function DetailCard({ cur, ac, paused, sm, setPaused, showPause }) {
    return (
        <div style={{
            ...
            <span style={{ position: "absolute", top: 0, left: 0, height: 2, width: "70%", background: `linear-gradient(90deg,transparent,${ac},#FFBA08,transparent)`, pointerEvents: "none", animation: "moveTop 2.5s linear infinite" }} />
            <span style={{ position: "absolute", top: 0, right: 0, width: 2, height: "70%", background: `linear-gradient(180deg,transparent,${ac},#FFBA08,transparent)`, pointerEvents: "none", animation: "moveRight 2.5s linear infinite", animationDelay: "0.6s" }} />
            <span style={{ position: "absolute", bottom: 0, right: 0, height: 2, width: "70%", background: `linear-gradient(270deg,transparent,${ac},#FFBA08,transparent)`, pointerEvents: "none", animation: "moveBottom 2.5s linear infinite", animationDelay: "1.2s" }} />
            <span style={{ position: "absolute", bottom: 0, left: 0, width: 2, height: "70%", background: `linear-gradient(0deg,transparent,${ac},#FFBA08,transparent)`, pointerEvents: "none", animation: "moveLeft 2.5s linear infinite", animationDelay: "1.8s" }} />
            ...
            <div style={{
                ...
                <div>
                    ...
                    <p style={{
                        ...
                        color: "rgba(255,230,160,0.78)", lineHeight: 1.8,
                        margin: 0,
                    }}>{cur.desc}</p>
                </div>
            ...
            <div style={{
                ...
                <div
                    style={{
                        height: "100%",
                        background: `linear-gradient(90deg,${ac},#FFBA08)`,
            ...
            <div style={{
                ...
                <span style={{
                    ...
                    color: "rgba(255,200,100,0.38)", letterSpacing: "0.1em", textTransform: "uppercase",
    ...
    return (
        <div style={{ width: "100%", minWidth: 0, paddingTop: 70 }}>
            ...
            <section style={{
                ...
                position: "relative", overflow: "hidden",
                backgroundImage: "radial-gradient(circle at 78% 28%, rgba(255,60,40,0.10), transparent 50%), radial-gradient(circle at 8% 85%, rgba(107,63,168,0.2), transparent 50%)",
                ...
                <div style={{
                    ...
                    background: "linear-gradient(180deg,transparent,#FF3C28,transparent)",
                ...
                <div style={{ position: "relative", zIndex: 2, maxWidth: 680, width: "100%" }}>
                    ...
                    <Reveal delay={0.12}>
                        <p style={{
                            ...
                            QwikGen is a web and product development team based in Hyderabad. We design and build websites, applications, and digital products for businesses that need things done properly — on time, on scope, and to a high standard.
                        </p>
                    </Reveal>
                    <Reveal delay={0.18}>
                        <div style={{ display: "flex", gap: "0.6rem", flexWrap: "wrap", marginTop: sm ? "1.4rem" : "2rem" }}>
                            {["Hyderabad, India", "100% In-House", "Full-Stack Capability", "No Middlemen"].map(t => (
                                <span key={t} style={{
                                    ...
                                    color: "#FFBA08", letterSpacing: "0.06em",
                                }}>{t}</span>
                            ))}
                        </div>
                    </Reveal>
                ...
                <div style={{
                    ...
                    <Reveal style={{ height: "100%" }}>
                        <div style={{
                            ...
                            boxShadow: "0 20px 60px rgba(61,26,120,0.25)",
                        }}>
                            ...
                            <div style={{
                                ...
                                background: "rgba(255,60,40,0.12)", border: "1px solid rgba(255,60,40,0.18)",
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "1.4rem", justifyContent: "center" }}>
                        ...
                        <Reveal delay={0.1}>
                            <div style={{
                                ...
                                boxShadow: "0 4px 18px rgba(61,26,120,0.05)",
                            ...
                            <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
                                <button
                                    ...
                                    style={{
                                        ...
                                        boxShadow: "0 4px 18px rgba(255,60,40,0.28)",
                                ...
                                <button
                                    ...
                                    style={{
                                        ...
                                        border: "none",
                                        padding: "0.88rem 1.9rem", borderRadius: 50,
                                        boxShadow: "0 4px 18px rgba(61,26,120,0.28)",
                                        display: "inline-flex", alignItems: "center", gap: "0.5rem",
                                        transition: "all 0.22s", whiteSpace: "nowrap",
            ...
            <section style={{ background: C.cream, padding: sectionPad }}>
                <Reveal>
                    <div style={{
                        ...
                        position: "relative", overflow: "hidden",
                        boxShadow: "0 4px 24px rgba(61,26,120,0.06)",
                    }}>
                        <div style={{
                ...
                <Reveal>
                    <div style={{
                        ...
                        <div style={{
                            ...
                            background: "radial-gradient(circle, rgba(255,60,40,0.18), transparent 65%)",
                            pointerEvents: "none",
                        }} />
                        ...
                        <button
                            ...
                            style={{
                                ...
                                transition: "all 0.25s",
                                display: "inline-flex", alignItems: "center", gap: "0.5rem",
                                boxShadow: "0 6px 24px rgba(255,60,40,0.35)",
