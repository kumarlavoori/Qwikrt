    ...
    return (
        ...
        >
            <div style={{
                ...
                overflow: "hidden",
                boxShadow: isCurrent
                    ? `0 10px 40px rgba(255,60,40,0.13), 0 2px 12px rgba(61,26,120,0.06)`
                    : hov ? `0 8px 28px rgba(61,26,120,0.09)` : `0 2px 10px rgba(61,26,120,0.04)`,
                ...
                <div>
                    <div style={{ display: "flex", alignItems: "center", gap: "0.55rem", marginBottom: "0.65rem" }}>
                        <div style={{
                            ...
                            background: isActive ? "rgba(255,60,40,0.07)" : C.creamDark,
                            border: `1.5px solid ${isActive ? "rgba(255,60,40,0.15)" : C.creamDark}`,
                        ...
                        <span style={{
                            ...
                            border: `1px solid ${isActive ? "rgba(255,60,40,0.15)" : C.creamDark}`,
                            transition: "all 0.4s",
                        }}>{step.phase}</span>
                    </div>
                    <div style={{
                ...
                <div style={{ display: "flex", flexDirection: "column", gap: "0.4rem" }}>
                    {step.details.map((d, di) => (
                        <div key={d} style={{
                            background: isActive ? "rgba(255,60,40,0.04)" : C.creamDark,
                            border: `1px solid ${isActive ? "rgba(255,60,40,0.1)" : C.creamDark}`,
        ...
        return (
            <div style={{ width: "100%", height: H, position: "relative", pointerEvents: "none" }}>
                ...
                <div style={{
                    ...
                    width: trackW,
                    height: `${fillPct}%`,
                    background: "linear-gradient(180deg, #FF3C28, #6B3FA8)",
                    borderRadius: 4,
                    boxShadow: fillPct > 0 ? "0 0 8px rgba(255,60,40,0.5)" : "none",
        ...
        <div style={{ width: "100%", height: H, pointerEvents: "none" }}>
            <svg width={containerWidth} height={H} style={{ display: "block", overflow: "visible" }}>
                ...
                <path
                    ...
                    style={{
                        filter: "drop-shadow(0 0 5px rgba(255,60,40,0.5))",
